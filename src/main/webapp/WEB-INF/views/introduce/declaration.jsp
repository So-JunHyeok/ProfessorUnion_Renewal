...
<script src="resources\js\jquery-3.3.1.min.js" charset="utf-8"></script>
  ...
  <link rel="stylesheet" href="resources/css/introduce/declaration.css">
 	...
 	<jsp:include page="/resources/sidebar.jsp"></jsp:include>
      ...
      <div class="declaration-content">
		...
		오늘 우리의 대학은 총체적인 위기에 처해 있다. 교육인적자원부(이하 교육부)와 사학재단의 왜곡된 대학지배는 위기의 본질이고 원천이다. 더욱이 최근 정부의 무분별한 대학정책은 위기를 한층 심화시키고 있다. 
            ...
            <li>사학재단의 전횡적 대학지배는 관료제적 통제보다 더 근본적인 대학 위기의 요인이다. 재단이 대학을 축재와 영리수단으로 악용하고 교육부가 그에 대한 감독을 방기하는 데서 우리 사회의 구조적 병폐인 사학비리가 생겨났다. 비리의 장본인인 사학재단은 교육부를 먹이사슬로 끌어들이고 국회 상임위를 포함하는 요처에 전방위 로비를 벌이며, 대학 민주화를 위해 헌신하는 교수들을 탄압하고 있다. 비리사학재단을 몸통으로 한 부패의 공생구조가 교권을 억압하고 학생들의 학습권을 부정하고 대학을 황폐화시키고 있는 것이다. </li>
            <li>
