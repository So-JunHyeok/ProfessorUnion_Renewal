...
<head>
  ...
  <link rel="stylesheet" href="resources/css/corruptionWrite.css">
     ...
     <jsp:include page="/resources/sidebar.jsp"></jsp:include>
      ...
      <div class="agony-content">
        ...
        <div class="agony-write-table">
          <form action="corruptionWriter" method="post">
            <table>
              <tr>
                <th>제목</th>
                <th>이름</th>
              ...
              <tr>
                <td><input type="text" name="ct_title" placeholder="제목 입력" required></td>
                <td><input type="text" name="ct_name" placeholder="실명 입력" maxlength="5" required></td>
                <td><input type="text" name="ct_university" placeholder="OOO대학교 입력" maxlength="9" required></td>
              </tr>
              <tr>
                <th colspan="3">내용</th>
              </tr>
              <tr>
                <td colspan="3"><textarea name="ct_content" id="ct_content" cols="30" rows="10" required></textarea></td>
              </tr>
            </table>
            <div class="agony-write-btn">
              <div class="agony-write-btn1">
                <input type="submit" value="신청하기">
                <input type="button" value="목록보기" onclick="location.href='corruptionUserList'">
              </div>
              <div class="agony-write-btn2">
              	<div class="authhority-text">
              		<h3>대학유형</h3>
              	</div>
                <select name="ct_authority">
