    ...
    <div class="contents-container">
      ...
      <div class="detail-content">
        ...
        <div class="detail-table">
          <form action="agonyUpdate?anum=${detail.anum}" method="post">
          <table>
            <tr>
              <th>소속대학</th>
              <td>
                <input type="text" name="auniversity" size="20" value="${detail.auniversity}" maxlength="9" required>
              </td>
            </tr>
            <tr>
              <th>제목</th>
              <td>
                <input type="text" name="atitle" size="20" value="${detail.atitle}" required>
              </td>
            </tr>
            <tr>
              <th>이름</th>
              <td>
                <input type="text" name="aname" size="20" value="${detail.aname}" maxlength="5" required>
              </td>
            </tr>
            <tr>
              <th colspan="2">내용</th>
            ...
            <tr>
              <td colspan="2">
                <textarea name="acontent" id="acontent" cols="30" rows="10" required>${detail.acontent}</textarea>
              </td>
            </tr>
            <tr>
              <td colspan="2">
