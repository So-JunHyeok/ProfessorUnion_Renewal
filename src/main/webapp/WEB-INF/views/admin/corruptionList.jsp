    ...
    <div class="content_title">
        ...
        <div class="config_sumit">
              ...
              <!-- 관리자 비밀번호를 입력해야 매핑값 전달 가능  -->
               <!--  <span>관리자비밀번호입력</span><input type="password" name="cf_adminpass" value="">
                <input type="button" name="membermodify" value="제출"  onclick="listSubmit()" > -->
                  <form action="corruptionList" style="width: 100%; display: flex;">
            <div class="list-search-select">
              <select name="searchOption" style="height: 21px;">
            ...
            <div class="list-search-btn">
              <input class="submitbt" type="submit" name="" value="검색" style="margin-left: 93px;">
            </div>
          </form>
        ...
        <div class="list-table">
          <table>
            <tr>
              ...
              <th>대학유형</th>
              <th>소속대학</th>
              <th class="corruption-title">제목</th>
              <th>실명</th>
              <th>작성자</th>
              <th>날짜</th>
              <th>읽음여부</th>
