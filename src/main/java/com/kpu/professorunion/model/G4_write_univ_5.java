...
public class G4_write_univ_5 {
	...
	public G4_write_univ_5() {
		
	}

	public G4_write_univ_5(int wr_id, int wr_num, String wr_reply, int wr_parent, int wr_is_comment, int wr_comment,
			String wr_comment_reply, String ca_name, String wr_option, String wr_subject, String wr_content,
			String wr_link1, String wr_link2, int wr_link1_hit, int wr_link2_hit, String wr_trackback, int wr_hit,
			int wr_good, int wr_nogood, String mb_id, String wr_password, String wr_name, String wr_email,
			String wr_hompage, Timestamp wr_datetime, String wr_last, String wr_ip, String wr_1, String wr_2,
			String wr_3, String wr_4, String wr_5, String wr_6, String wr_7, String wr_8, String wr_9, String wr_10) {
		this.wr_id = wr_id;
		this.wr_num = wr_num;
	...
	public String getWr_hompage() {
		return wr_hompage;
	}

	public void setWr_hompage(String wr_hompage) {
		this.wr_hompage = wr_hompage;
	}
