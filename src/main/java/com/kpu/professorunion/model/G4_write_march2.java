...
public class G4_write_march2 {
	...
	public G4_write_march2() {
		
	}

	public G4_write_march2(int wr_id, int wr_num, String wr_reply, int wr_parent, int wr_is_comment, int wr_comment,
